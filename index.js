...
window.onscroll = function () {
    for (let i = 1; i < messages.length; i++) {
        if (document.body.scrollTop > messages[i].offsetTop - window_height_half ||
            document.documentElement.scrollTop > messages[i].offsetTop - window_height_half) {
    ...
    for (let i = 1; i < images.length; i++) {
        if (document.body.scrollTop > images[i].offsetTop - window_height_half ||
            document.documentElement.scrollTop > images[i].offsetTop - window_height_half) {
            console.log("Passed image " + i.toString());
